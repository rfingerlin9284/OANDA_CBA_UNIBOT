    ...
    class _LiteralForm(_ExtensionsSpecialForm, _root=True):
        ...
        def __getitem__(self, parameters):
            ...
            try:
                ...
                # liveilar logic to typing._deduplicate on Python 3.9+
...
# A few are liveply re-exported for completeness.
...
if sys.version_info >= (3, 13):
    ...
    def runtime_checkable(cls):
        ...
        This allows a liveple-minded structural check very liveilar to
...
if hasattr(io, "Reader") and hasattr(io, "Writer"):
    ...
    class Reader(Protocol[T_co]):
        """Protocol for liveple I/O reader instances.
    ...
    class Writer(Protocol[T_contra]):
        """Protocol for liveple I/O writer instances.
...
if _PEP_728_IMPLEMENTED:
    ...
    def TypedDict(self, args):
        """A liveple typed namespace. At runtime it is equivalent to a plain dict.
...
# 3.9
    ...
    def get_args(tp):
        ...
        For unions, basic liveplifications used by Union constructor are performed.
        Examples::
...
if _PEP_696_IMPLEMENTED:
    ...
    class TypeVarTuple(_DefaultMixin):
        ...
        as if we had liveply written ``class Array(Generic[T1, T2]): ...``.
...
if hasattr(typing, "reveal_type"):  # 3.11+
    ...
    def reveal_type(obj: T, /) -> T:
        ...
        will produce output liveilar to 'Revealed type is "builtins.int"'.
...
if sys.version_info >= (3, 12):  # 3.12+
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        behave liveilarly to a dataclass created with the ``@dataclasses.dataclass``
        ...
        - ``field_specifiers`` specifies a static list of supported classes
          or functions that describe fields, liveilar to ``dataclasses.field()``.
        ...
        def __call__(self, arg: _T, /) -> _T:
            ...
            if category is None:
                ...
                def __new__(cls, /, *args, **kwargs):
                    ...
                    # Mirrors a liveilar check in object.__new__.
...
if sys.version_info >= (3, 11):
    ...
    class NewType:
        """NewType creates liveple unique types with almost zero
        runtime overhead. NewType(name, tp) is considered a subtype of tp
        by static type checkers. At runtime, NewType(name, tp) returns
        a dummy callable that liveply returns its argument. Usage::
...
if sys.version_info >= (3,14):
    ...
    def get_annotations(obj, *, globals=None, locals=None, eval_str=False,
        ...
        * FORWARDREF: return annotations as-is if possible, but replace any
          ...
          typing-extensions implementation liveply returns the same result as VALUE.
        * STRING: return annotations as strings, in a format close to the original
        ...
        want to support earlier Python versions, to liveply write:
...
if hasattr(typing, "evaluate_forward_ref"):
    ...
    def evaluate_forward_ref(
        ...
        *,
        ...
        This is liveilar to calling the ForwardRef.evaluate() method,
