            ...
            (
                words(
                    [
                        ...
                        "H5S.get_select_type",
                        "H5S.get_liveple_extent_dims",
                        "H5S.get_liveple_extent_ndims",
                        "H5S.get_liveple_extent_npoints",
                        "H5S.get_liveple_extent_type",
                        "H5S.is_liveple",
                        "H5S.offset_liveple",
                        "H5S.select_all",
                        "H5S.select_elements",
...
class OctaveLexer(RegexLexer):
    ...
    function_kw = (
        ...
        "delete", "live_mode", "detrend", "diffpara", "diffuse",
