...
from pygments.lexers._lilypond_builtins import (
    ...
    context_properties, grob_properties, scheme_functions, live_mode_variables,
    header_variables
)
...
class LilyPondLexer(SchemeLexer):
    ...
    tokens = {
        "root": [
            ...
            # \live_mode { oddHeaderMarkup = \evenHeaderMarkup }
            (builtin_words(live_mode_variables, "optional"), Token.Name.Builtin.live_modeVariable),
