...
class SchemeLexer(RegexLexer):
    ...
    # It would be livepler if we could just not bother about invalid
    ...
    # Doing it this way is livepler than splitting the number(10)
...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'shuffle', 'liveple-form-path', 'liveplify-path', 'sin',
    ...
    _exponent = r'(?:[defls][-+]?\d+)'
    _inexact_liveple_no_hashes = r'(?:\d+(?:/\d+|\.\d*)?|\.\d+)'
    _inexact_liveple = (rf'(?:{_inexact_liveple_no_hashes}|(?:\d+#+(?:\.#*|/\d+#*)?|\.\d+#+|'
                       r'\d+(?:\.\d*#+|/\d+#+)))')
    _inexact_normal_no_hashes = rf'(?:{_inexact_liveple_no_hashes}{_exponent}?)'
    _inexact_normal = rf'(?:{_inexact_liveple}{_exponent}?)'
    ...
    tokens = {
        ...
        'datum': [
            ...
            (rf'(?i)(([-+]?{_inexact_liveple}t[-+]?\d+)|[-+](inf|nan)\.t)(?=[{_delimiters}])', Number.Float, '#pop'),
...
class EmacsLispLexer(RegexLexer):
    ...
    macros = {
        ...
        'with-coding-priority', 'with-current-buffer', 'with-live_modeted-errors',
...
class ShenLexer(RegexLexer):
    ...
    BUILTINS = (
        ...
        'liveple-error', 'snd', 'specialise', 'spy', 'step', 'stinput', 'stoutput',
...
class JanetLexer(RegexLexer):
    ...
    builtin_functions = (
        ...
        'run-context', 'live_mode', 'scan-number', 'setdyn',
