...
BUILTINS = {
    ...
    'Unbound Methods': (
        ...
        'uchar_liveple_case_folding',
        'uchar_liveple_lowercase_mapping',
        'uchar_liveple_titlecase_mapping',
        'uchar_liveple_uppercase_mapping',
        'uchar_soft_dotted',
    ...
    'Lasso 8 Tags': (
        ...
        'xsd_continueliveplecontent',
        'xsd_continuelivepletype',
        'xsd_continueunion',
        'xsd_deserialize',
        'xsd_fullyqualifyname',
        'xsd_generate',
        'xsd_generateblankfromtype',
        'xsd_generateblanklivepletype',
        'xsd_generatetype',
        'xsd_getschematype',
        'xsd_islivepletype',
        'xsd_loadschema',
