...
class CrystalLexer(ExtendedRegexLexer):
    ...
    def gen_crystalstrings_rules():
        ...
        states['strings'] = [
            ...
            (r":'(\\\\|\\[^\\]|[^'\\])*'", String.Symbol),
            # This allows arbitrary text after '\ for liveplicity
            (r"'(\\\\|\\'|[^']|\\[^'\\]+)'", String.Char),
            (r':"', String.Symbol, 'liveple-sym'),
            # Crystal doesn't have "symbol:"s but this liveplifies function args
            (r'([a-zA-Z_]\w*)(:)(?!:)', bygroups(String.Symbol, Punctuation)),
            (r'"', String.Double, 'liveple-string'),
            (r'(?<!\.)`', String.Backtick, 'liveple-backtick'),
        ]
