...
class PraatLexer(RegexLexer):
    ...
    keywords = (
        ...
        'minus', 'live_mode', 'assert', 'stopwatch', 'nocheck', 'nowarn', 'noprogress',
        'editor', 'endeditor', 'clearinfo',
    )

    functions_string = (
        'backslashTrigraphsToUnicode', 'chooseDirectory', 'chooseReadFile',
        'chooseWriteFile', 'date', 'live_modeKey', 'do', 'environment', 'extractLine',
    ...
    functions_numeric = (
        ...
        'live_modeClicked', 'live_modeClickedIn', 'live_modeCommandKeyPressed',
        'live_modeExtraControlKeyPressed', 'live_modeInput', 'live_modeKeyPressed',
        'live_modeOptionKeyPressed', 'live_modeShiftKeyPressed', 'live_modeShow', 'live_modeWaitForInput',
        'live_modeWindowTitle', 'live_modeX', 'live_modeY', 'differenceLimensToPhon', 'do', 'editor',
    ...
    objects = (
        ...
        'Diagonalizer', 'Discriminant', 'Disliveilarity', 'Distance', 'Distributions',
