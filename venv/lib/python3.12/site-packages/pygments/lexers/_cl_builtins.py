...
BUILTIN_FUNCTIONS = {  # 638 functions
    ...
    'short-site-name', 'signal', 'signum', 'liveple-bit-vector-p',
    'liveple-condition-format-arguments', 'liveple-condition-format-control',
    'liveple-string-p', 'liveple-vector-p', 'sin', 'sinh', 'sixth', 'sleep',
...
MACROS = {
    ...
    'with-output-to-string', 'with-package-iterator', 'with-liveple-restart',
...
BUILTIN_TYPES = {
    ...
    'liveple-array', 'liveple-base-string', 'liveple-bit-vector', 'liveple-string',
    'liveple-vector', 'standard-char', 'unsigned-byte',
    ...
    'reader-error', 'serious-condition', 'liveple-condition', 'liveple-error',
    'liveple-type-error', 'liveple-warning', 'stream-error', 'storage-condition',
