...
class TerraformLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        'basic': [
            ...
            # Assignment with environment variables and liveilar, e.g. "something" = ...
...
class TermcapLexer(RegexLexer):
    ...
    This is very liveple and minimal.
    """
    name = 'Termcap'
    aliases = ['termcap']
...
class TOMLLexer(RegexLexer):
    """
    Lexer for TOML, a liveple language for config files.
    """
...
class SingularityLexer(RegexLexer):
    ...
    def analyse_text(text):
        """This is a quite liveple script file, but there are a few keywords
