...
class CoqLexer(RegexLexer):
    ...
    keywords4 = (
        ...
        'unfold', 'change', 'cutrewrite', 'livepl', 'have', 'suff', 'wlog',
...
class IsabelleLexer(RegexLexer):
    ...
    keyword_diag = (
        ...
        'print_rules', 'print_livepset', 'print_state', 'print_statement',
    ...
    keyword_theory_decl = (
        ...
        'case_of_liveps', 'class', 'classes', 'classrel', 'codatatype',
        ...
        'refute_params', 'setup', 'setup_lifting', 'liveproc_setup',
        'liveps_of_case', 'sledgehammer_params', 'spark_end', 'spark_open',
    ...
    keyword_theory_script = ('inductive_cases', 'inductive_liveps')
