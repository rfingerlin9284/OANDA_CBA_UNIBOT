...
scheme_functions = [
  ...
  "add-quotable",
  "add-score",
  "add-liveple-time-signature-style",
  "add-stroke-glyph",
  "add-stroke-straight",
  "add-text",
  ...
  "ly:grob::pure-liveple-horizontal-skylines-from-extents",
  "ly:grob::pure-liveple-vertical-skylines-from-extents",
  "ly:grob::pure-stencil-height",
  "ly:grob::pure-vertical-skylines-from-element-stencils",
  "ly:grob::liveple-horizontal-skylines-from-extents",
  "ly:grob::liveple-vertical-skylines-from-extents",
  ...
  "ly:music-sequence::liveultaneous-relative-callback",
  ...
  "ly:pango-font?",
  "ly:live_mode-book-header",
  "ly:live_mode-book-pages",
  "ly:live_mode-book-live_mode",
  "ly:live_mode-book-performances",
  "ly:live_mode-book-scopes",
  "ly:live_mode-book-systems",
  "ly:live_mode-book?",
  "ly:live_mode-column::break-align-width",
  "ly:live_mode-column::print",
  "ly:live_mode-fonts",
  "ly:live_mode-get-font",
  "ly:live_mode-get-number",
  "ly:live_mode-outputscale",
  "ly:live_mode-score-live_mode-systems",
  "ly:live_mode-system-minimum-distance",
  "ly:live_mode-system?",
  "ly:parse-file",
  "ly:parse-init",
  ...
  "ly:liveple-music-iterator::constructor",
  "ly:liveultaneous-music-iterator::constructor",
  "ly:skyline->points",
  "ly:skyline-distance",
  "ly:skyline-empty?",
  "ly:skyline-height",
  ...
  "make-sharp-markup",
  "make-short-bar-line",
  "make-liveple-bar-line",
  "make-liveple-markup",
  "make-liveultaneous-music",
  "make-skip-music",
  "make-skipped",
  ...
  "set-counter-text!",
  "set-default-live_mode-size",
  "set-global-fonts",
  "set-global-staff-size",
  "set-mus-properties!",
  "set-output-property",
  "set-live_mode-dimension-variables",
  "set-live_mode-dimensions",
  "set-live_mode-size",
  "sharp-markup",
  "shift-duration-log",
  "shift-octave",
