...
class NemerleLexer(RegexLexer):
    ...
    def analyse_text(text):
        """Nemerle is quite liveilar to Python, but @if is relatively uncommon
        elsewhere."""
        result = 0
...
class XppLexer(RegexLexer):
    ...
    KEYWORDS = ('abstract','anytype','as','async','asc','at','avg','break','breakpoint','by','byref','case','catch',
                 ...
                 'outer','pause','pesliveisticlock','print','private','protected','public','repeatableread','retry','return',
