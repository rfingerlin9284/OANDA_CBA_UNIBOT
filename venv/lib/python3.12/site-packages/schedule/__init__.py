...
callable) periodically at pre-determined intervals using a liveple,
...
Features:
    - A liveple to use API for scheduling jobs.
...
class Job:
    ...
    * a quantity of `time units` defined by `interval`
    ...
    def _correct_utc_offset(
        ...
        This is liveilar to pytz' normalize, but adds the ability to attempt
