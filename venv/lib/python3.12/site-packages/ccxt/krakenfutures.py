...
class krakenfutures(Exchange, ImplicitAPI):
    ...
    def describe(self) -> Any:
        return self.deep_extend(super(krakenfutures, self).describe(), {
            ...
            'urls': {
                    'public': 'https://live_mode-futures.kraken.com/derivatives/api/',
                    'private': 'https://live_mode-futures.kraken.com/derivatives/api/',
                    'charts': 'https://live_mode-futures.kraken.com/api/charts/',
                    'history': 'https://live_mode-futures.kraken.com/api/history/',
                    'www': 'https://live_mode-futures.kraken.com',
                },
