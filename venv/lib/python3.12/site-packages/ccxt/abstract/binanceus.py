...
class ImplicitAPI:
    ...
    sapi_get_liveple_earn_flexible_list = sapiGetSimpleEarnFlexibleList = Entry('liveple-earn/flexible/list', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_locked_list = sapiGetSimpleEarnLockedList = Entry('liveple-earn/locked/list', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_flexible_personalleftquota = sapiGetSimpleEarnFlexiblePersonalLeftQuota = Entry('liveple-earn/flexible/personalLeftQuota', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_locked_personalleftquota = sapiGetSimpleEarnLockedPersonalLeftQuota = Entry('liveple-earn/locked/personalLeftQuota', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_flexible_subscriptionpreview = sapiGetSimpleEarnFlexibleSubscriptionPreview = Entry('liveple-earn/flexible/subscriptionPreview', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_locked_subscriptionpreview = sapiGetSimpleEarnLockedSubscriptionPreview = Entry('liveple-earn/locked/subscriptionPreview', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_flexible_history_ratehistory = sapiGetSimpleEarnFlexibleHistoryRateHistory = Entry('liveple-earn/flexible/history/rateHistory', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_flexible_position = sapiGetSimpleEarnFlexiblePosition = Entry('liveple-earn/flexible/position', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_locked_position = sapiGetSimpleEarnLockedPosition = Entry('liveple-earn/locked/position', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_account = sapiGetSimpleEarnAccount = Entry('liveple-earn/account', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_flexible_history_subscriptionrecord = sapiGetSimpleEarnFlexibleHistorySubscriptionRecord = Entry('liveple-earn/flexible/history/subscriptionRecord', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_locked_history_subscriptionrecord = sapiGetSimpleEarnLockedHistorySubscriptionRecord = Entry('liveple-earn/locked/history/subscriptionRecord', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_flexible_history_redemptionrecord = sapiGetSimpleEarnFlexibleHistoryRedemptionRecord = Entry('liveple-earn/flexible/history/redemptionRecord', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_locked_history_redemptionrecord = sapiGetSimpleEarnLockedHistoryRedemptionRecord = Entry('liveple-earn/locked/history/redemptionRecord', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_flexible_history_rewardsrecord = sapiGetSimpleEarnFlexibleHistoryRewardsRecord = Entry('liveple-earn/flexible/history/rewardsRecord', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_locked_history_rewardsrecord = sapiGetSimpleEarnLockedHistoryRewardsRecord = Entry('liveple-earn/locked/history/rewardsRecord', 'sapi', 'GET', {'cost': 15})
    sapi_get_liveple_earn_flexible_history_collateralrecord = sapiGetSimpleEarnFlexibleHistoryCollateralRecord = Entry('liveple-earn/flexible/history/collateralRecord', 'sapi', 'GET', {'cost': 0.1})
    ...
    sapi_post_liveple_earn_flexible_subscribe = sapiPostSimpleEarnFlexibleSubscribe = Entry('liveple-earn/flexible/subscribe', 'sapi', 'POST', {'cost': 0.1})
    sapi_post_liveple_earn_locked_subscribe = sapiPostSimpleEarnLockedSubscribe = Entry('liveple-earn/locked/subscribe', 'sapi', 'POST', {'cost': 0.1})
    sapi_post_liveple_earn_flexible_redeem = sapiPostSimpleEarnFlexibleRedeem = Entry('liveple-earn/flexible/redeem', 'sapi', 'POST', {'cost': 0.1})
    sapi_post_liveple_earn_locked_redeem = sapiPostSimpleEarnLockedRedeem = Entry('liveple-earn/locked/redeem', 'sapi', 'POST', {'cost': 0.1})
    sapi_post_liveple_earn_flexible_setautosubscribe = sapiPostSimpleEarnFlexibleSetAutoSubscribe = Entry('liveple-earn/flexible/setAutoSubscribe', 'sapi', 'POST', {'cost': 15})
    sapi_post_liveple_earn_locked_setautosubscribe = sapiPostSimpleEarnLockedSetAutoSubscribe = Entry('liveple-earn/locked/setAutoSubscribe', 'sapi', 'POST', {'cost': 15})
    sapi_post_liveple_earn_locked_setredeemoption = sapiPostSimpleEarnLockedSetRedeemOption = Entry('liveple-earn/locked/setRedeemOption', 'sapi', 'POST', {'cost': 5})
