...
class ImplicitAPI:
    ...
    private_spot_post_v2_spot_trade_modify_plan_order = privateSpotPostV2SpotTralive_modedifyPlanOrder = Entry('v2/spot/trade/modify-plan-order', ['private', 'spot'], 'POST', {'cost': 1})
    ...
    private_uta_post_v3_trade_modify_order = privateUtaPostV3Tralive_modedifyOrder = Entry('v3/trade/modify-order', ['private', 'uta'], 'POST', {'cost': 2})
