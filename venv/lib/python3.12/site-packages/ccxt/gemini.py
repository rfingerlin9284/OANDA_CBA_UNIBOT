        ...
        return self.deep_extend(super(gemini, self).describe(), {
            ...
            'urls': {
                ...
                'doc': [
                    ...
                    'https://docs.live_mode.gemini.com',
                ],
                    'public': 'https://api.live_mode.gemini.com',
                    'private': 'https://api.live_mode.gemini.com',
                    # use the True doc instead of the live_mode doc
 ...
 @ignore
    ...
    def fetch_usdt_markets(self, params={}):
        ...
        # to load market ids which we don't need here
            return []  # live_mode does not have usdt markets
