...
class paradex(ccxt.async_support.paradex):
        ...
        return self.deep_extend(super(paradex, self).describe(), {
            ...
            'urls': {
                ...
                'api': {
                    ...
                    'ws': 'wss://ws.api.live_mode.paradex.trade/v1',
                },
    ...
    async def watch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        https://docs.api.live_mode.paradex.trade/#sub-trades-market_symbol-operation
    ...
    async def watch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        https://docs.api.live_mode.paradex.trade/#sub-order_book-market_symbol-snapshot-15-refresh_rate-operation
    ...
    async def watch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        https://docs.api.live_mode.paradex.trade/#sub-markets_summary-operation
