...
class okx(ccxt.async_support.okx):
    ...
    def get_url(self, channel: str, access='public'):
        ...
        islive_mode = self.options['live_modeMode']
        live_modeSuffix = '?brokerId=9999' if islive_mode else ''
        isBusiness = (access == 'business')
        isPublic = (access == 'public')
        url = self.urls['api']['ws']
        if isBusiness or (channel.find('candle') > -1) or (channel == 'orders-algo'):
            return url + '/business' + live_modeSuffix
        elif isPublic:
            return url + '/public' + live_modeSuffix
        return url + '/private' + live_modeSuffix
