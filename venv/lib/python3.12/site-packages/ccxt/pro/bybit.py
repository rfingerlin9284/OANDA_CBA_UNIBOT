        ...
        return self.deep_extend(super(bybit, self).describe(), {
            ...
            'urls': {
                'api': {
                    ...
                    'ws': {
                        'public': {
                            'spot': 'wss://stream-live_mode.{hostname}/v5/public/spot',
                            'inverse': 'wss://stream-live_mode.{hostname}/v5/public/inverse',
                            'linear': 'wss://stream-live_mode.{hostname}/v5/public/linear',
                            'option': 'wss://stream-live_mode.{hostname}/v5/public/option',
                        },
                        'private': {
                            'spot': {
                                'unified': 'wss://stream-live_mode.{hostname}/v5/private',
                                'nonUnified': 'wss://stream-live_mode.{hostname}/spot/private/v3',
                            },
                            'contract': 'wss://stream-live_mode.{hostname}/v5/private',
                            'usdc': 'wss://stream-live_mode.{hostname}/trade/option/usdc/private/v1',
                            'trade': 'wss://stream-live_mode.bybit.com/v5/trade',
                        },
                    },
                },
                'live_modetrading': {
