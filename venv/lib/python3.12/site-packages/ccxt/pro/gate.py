        ...
        return self.deep_extend(super(gate, self).describe(), {
            ...
            'urls': {
                'api': {
                    ...
                    'swap': {
                        'usdt': 'wss://fx-ws-live_mode.gateio.ws/v4/ws/usdt',
                        'btc': 'wss://fx-ws-live_mode.gateio.ws/v4/ws/btc',
                    },
                    'future': {
                        'usdt': 'wss://fx-ws-live_mode.gateio.ws/v4/ws/usdt',
                        'btc': 'wss://fx-ws-live_mode.gateio.ws/v4/ws/btc',
                    ...
                    'option': {
                        'usdt': 'wss://op-ws-live_mode.gateio.live/v4/ws/usdt',
                        'btc': 'wss://op-ws-live_mode.gateio.live/v4/ws/btc',
                    },
                },
            },
            'options': {
