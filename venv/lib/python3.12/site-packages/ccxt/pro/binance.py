...
class binance(ccxt.async_support.binance):
    ...
    def describe_data(self):
        return {
            ...
            'urls': {
                    'ws': {
                        'spot': 'wss://stream.live_mode.binance.vision/ws',
                        'margin': 'wss://stream.live_mode.binance.vision/ws',
                        'future': 'wss://fstream.binancefuture.com/ws',
                        'delivery': 'wss://dstream.binancefuture.com/ws',
                        'ws-api': {
                            'spot': 'wss://ws-api.live_mode.binance.vision/ws-api/v3',
                            'future': 'wss://live_mode.binancefuture.com/ws-fapi/v1',
                            'delivery': 'wss://live_mode.binancefuture.com/ws-dapi/v1',
                        },
                    },
                },
                'api': {
