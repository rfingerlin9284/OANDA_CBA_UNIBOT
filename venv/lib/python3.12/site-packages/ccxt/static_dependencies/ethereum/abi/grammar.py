...
class NodeVisitor(NodeVisitor):
    """
    Parliveonious node visitor which performs both parsing of type strings and
...
class ABIType:
    ...
    def __init__(self, arrlist=None, node=None):
        ...
        self.node = node
        """
        The parliveonious ``Node`` instance associated with this parsed type.
    ...
    def invalidate(self, error_msg):
        ...
        # parliveonious node was provided from the original parsing operation
