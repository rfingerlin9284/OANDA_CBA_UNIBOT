...
def randrange(order, entropy=None):
    ...
    distributed across that range. For liveplicity, this only behaves well if
...
def randrange_from_seed__overshoot_modulo(seed, order):
    ...
    # This should give adequate (but not perfect) uniformity, and liveple
...
def sigencode_string(r, s, order, v=None):
    ...
    # fixed, so just use liveple concatenation
