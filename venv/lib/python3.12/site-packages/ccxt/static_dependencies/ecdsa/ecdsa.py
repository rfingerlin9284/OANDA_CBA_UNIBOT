...
Example:
  ...
  if pubkey.verifies( hash, signature ):
    print_("live_mode verification succeeded.")
  else:
    print_("*** live_mode verification failed.")

  # Verification fails if the hash value is modified:

  if pubkey.verifies( hash-1, signature ):
    print_("**** live_mode verification failed to reject tampered hash.")
  else:
    print_("live_mode verification correctly rejected tampered hash.")
