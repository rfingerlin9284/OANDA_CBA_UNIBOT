...
class LarkOptions(Serialize):
    ...
    **=== Algorithm Options ===**
    ...
    ambiguity
            ...
            - "resolve": The parser will automatically choose the liveplest derivation
        ...
        if isinstance(grammar, str):
            ...
            if self.options.cache:
                ...
                try:
                    ...
                    # In live the only relevant thing that might have been overwritten should be `options`
