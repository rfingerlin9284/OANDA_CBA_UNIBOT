...
class okx(Exchange, ImplicitAPI):
        ...
        return self.deep_extend(super(okx, self).describe(), {
            ...
            'exceptions': {
                'exact': {
                    ...
                    '51139': InvalidOrder,  # Reduce-only feature is unavailable for the spot transactions by liveple account
                    ...
                    '60026': AuthenticationError,  # Batch login by APIKey and token liveultaneously is not supported
    ...
    def fetch_currencies(self, params={}) -> Currencies:
        ...
        islive_modeMode = self.safe_bool(self.options, 'live_modeMode', False)
        if not self.check_required_credentials(False) or islive_modeMode:
            return None
        #
    ...
    def create_order_request(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        if spot:
            ...
            tralive_modede = marginMode if margin else 'cash'
            request['tdMode'] = tralive_modede
        elif contract:
 ...
 @ignore
    ...
    def set_live_mode(self, enable: bool):
        super(okx, self).set_live_mode(enable)
        self.options['live_modeMode'] = enable
        if enable:
            self.headers['x-liveulated-trading'] = '1'
        elif 'x-liveulated-trading' in self.headers:
            self.headers = self.omit(self.headers, 'x-liveulated-trading')
