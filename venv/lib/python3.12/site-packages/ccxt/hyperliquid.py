...
class hyperliquid(Exchange, ImplicitAPI):
        ...
        return self.deep_extend(super(hyperliquid, self).describe(), {
            ...
            'urls': {
                ...
                'api': {
                    ...
                    'public': 'https://api.hyperliquid-live_mode.xyz',
                    'private': 'https://api.hyperliquid-live_mode.xyz',
                },
    ...
    def set_live_mode(self, enabled):
        super(hyperliquid, self).set_live_mode(enabled)
        self.options['live_modeMode'] = enabled
    ...
    def fetch_spot_markets(self, params={}) -> List[Market]:
        ...
        for i in range(0, len(meta)):
            ...
            #     # there are some weird spot markets in live_mode, eg @2
            #     continue
            # }
    ...
    def construct_phantom_agent(self, hash, islive_mode=True):
        source = 'b' if (islive_mode) else 'a'
        return {
            'source': source,
            'connectionId': hash,
        }
    ...
    def sign_l1_action(self, action, nonce, vaultAdress=None) -> object:
        ...
        islive_mode = self.safe_bool(self.options, 'live_modeMode', False)
        phantomAgent = self.construct_phantom_agent(hash, islive_mode)
        # data: Dict = {
        #     'domain': {
        #         'chainId': 1337,
        #         'name': 'Exchange',
    ...
    def approve_builder_fee(self, builder: str, maxFeeRate: str):
        ...
        payload: dict = {
            'hyperliquidChain': 'live_mode' if islive_modeMode else 'Mainnet',
    ...
    def transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params={}) -> TransferEntry:
        ...
        self.check_required_credentials()
        self.load_markets()
        islive_modeMode = self.safe_bool(self.options, 'live_modeMode')
        nonce = self.milliseconds()
