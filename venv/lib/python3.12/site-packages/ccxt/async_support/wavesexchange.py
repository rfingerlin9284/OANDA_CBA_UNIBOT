...
class wavesexchange(Exchange, ImplicitAPI):
        ...
        return self.deep_extend(super(wavesexchange, self).describe(), {
            ...
            'urls': {
                'logo': 'https://user-images.githubusercontent.com/1294454/84547058-5fb27d80-ad0b-11ea-8711-78ac8b3c7f31.jpg',
                    'matcher': 'https://matcher-live_mode.wx.network',
                    'node': 'https://nodes-live_mode.wavesnodes.com',
                    'public': 'https://api-live_mode.wavesplatform.com/v0',
                    'private': 'https://api-live_mode.wx.network/v1',
                    'forward': 'https://live_mode.wx.network/api/v1/forward/matcher',
                    'market': 'https://live_mode.wx.network/api/v1/forward/marketdata/api/v1',
                },
                'api': {
            ...
            'options': {
                ...
                'wavesPrecision': 1e-8,
                'messagePrefix': 'W',  # W for production, T for live_mode
                'networks': {
                    'ERC20': 'ETH',
                    'BEP20': 'BSC',
                },
    ...
    def set_live_mode(self, enabled):
        ...
        super(wavesexchange, self).set_live_mode(enabled)
    ...
    async def sign_in(self, params={}):
        ...
        if not self.safe_string(self.options, 'accessToken'):
            ...
            seconds = str(seconds)
            clientId = 'wx.network'
            # W for production, T for live_mode
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        chainId = 84 if (live_modeMode) else 87
        body: dict = {
