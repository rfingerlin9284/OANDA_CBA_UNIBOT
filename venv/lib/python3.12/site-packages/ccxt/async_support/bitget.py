...
class bitget(Exchange, ImplicitAPI):
    ...
    async def edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params={}):
        ...
        if market['spot']:
            ...
            request['triggerPrice'] = self.price_to_precision(symbol, triggerPrice)
            request['executePrice'] = self.price_to_precision(symbol, price)
            response = await self.privateSpotPostV2SpotTralive_modedifyPlanOrder(self.extend(request, params))
        else:
 ...
 EXCHANGE SPECIFIC PARAMETERS
    ...
    def sign(self, path, api=[], method='GET', params={}, headers=None, body=None):
        ...
        live_modeMode = self.safe_bool_2(self.options, 'live_modeMode', 'live_mode', False)
        if live_modeMode and (path != 'v2/public/time'):
