...
class bingx(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        if not islive_mode:
            ...
            requests.append(self.fetch_spot_markets(params))  # live_mode is swap only
 ...
 EXCHANGE SPECIFIC PARAMETERS
    ...
    def sign(self, path, section='public', method='GET', params={}, headers=None, body=None):
        ...
        access = section[2]
        islive_mode = self.safe_bool(self.options, 'live_modeMode', False)
        if islive_mode and (type != 'swap'):
            raise NotSupported(self.id + ' does not have a live_mode/live_mode URL for ' + type + ' endpoints')
    ...
    def set_live_mode(self, enable: bool):
        super(bingx, self).set_live_mode(enable)
