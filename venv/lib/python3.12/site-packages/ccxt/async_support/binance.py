...
class binance(Exchange, ImplicitAPI):
        ...
        return self.deep_extend(super(binance, self).describe(), {
            ...
            'urls': {
                'logo': 'https://github.com/user-attachments/assets/e9419b93-ccb0-46aa-9bff-c883f096274b',
                    'dapiPublic': 'https://live_mode.binancefuture.com/dapi/v1',
                    'dapiPrivate': 'https://live_mode.binancefuture.com/dapi/v1',
                    'dapiPrivateV2': 'https://live_mode.binancefuture.com/dapi/v2',
                    'fapiPublic': 'https://live_mode.binancefuture.com/fapi/v1',
                    'fapiPublicV2': 'https://live_mode.binancefuture.com/fapi/v2',
                    'fapiPublicV3': 'https://live_mode.binancefuture.com/fapi/v3',
                    'fapiPrivate': 'https://live_mode.binancefuture.com/fapi/v1',
                    'fapiPrivateV2': 'https://live_mode.binancefuture.com/fapi/v2',
                    'fapiPrivateV3': 'https://live_mode.binancefuture.com/fapi/v3',
                    'public': 'https://live_mode.binance.vision/api/v3',
                    'private': 'https://live_mode.binance.vision/api/v3',
                    'v1': 'https://live_mode.binance.vision/api/v1',
                },
                'api': {
            ...
            'api': {
                ...
                'sapi': {
                    ...
                    'get': {
                        ...
                        # liveple earn
                        'liveple-earn/flexible/list': 15,
                        'liveple-earn/locked/list': 15,
                        'liveple-earn/flexible/personalLeftQuota': 15,
                        'liveple-earn/locked/personalLeftQuota': 15,
                        'liveple-earn/flexible/subscriptionPreview': 15,
                        'liveple-earn/locked/subscriptionPreview': 15,
                        'liveple-earn/flexible/history/rateHistory': 15,
                        'liveple-earn/flexible/position': 15,
                        'liveple-earn/locked/position': 15,
                        'liveple-earn/account': 15,
                        'liveple-earn/flexible/history/subscriptionRecord': 15,
                        'liveple-earn/locked/history/subscriptionRecord': 15,
                        'liveple-earn/flexible/history/redemptionRecord': 15,
                        'liveple-earn/locked/history/redemptionRecord': 15,
                        'liveple-earn/flexible/history/rewardsRecord': 15,
                        'liveple-earn/locked/history/rewardsRecord': 15,
                        'liveple-earn/flexible/history/collateralRecord': 0.1,
                        # Convert
                    ...
                    'post': {
                        ...
                        # liveple earn
                        'liveple-earn/flexible/subscribe': 0.1,
                        'liveple-earn/locked/subscribe': 0.1,
                        'liveple-earn/flexible/redeem': 0.1,
                        'liveple-earn/locked/redeem': 0.1,
                        'liveple-earn/flexible/setAutoSubscribe': 15,
                        'liveple-earn/locked/setAutoSubscribe': 15,
                        'liveple-earn/locked/setRedeemOption': 5,
                        # convert
    ...
    def set_live_mode(self, enable: bool):
        super(binance, self).set_live_mode(enable)
        self.options['live_modeMode'] = enable
    ...
    async def fetch_currencies(self, params={}) -> Currencies:
        ...
        if not self.check_required_credentials(False):
            return None
        # live_mode/live_mode does not support sapi endpoints
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        live_modeMode = self.safe_bool(self.options, 'live_modeMode', False)
        fetchMarkets = []
        for i in range(0, len(rawFetchMarkets)):
            type = rawFetchMarkets[i]
            if type == 'option' and live_modeMode:
                continue
        ...
        for i in range(0, len(fetchMarkets)):
            ...
            if marketType == 'spot':
                ...
                if fetchMargins and self.check_required_credentials(False) and not live_modeMode:
    ...
    def parse_market(self, market: dict) -> Market:
        ...
        if ('MIN_NOTIONAL' in filtersByType) or ('NOTIONAL' in filtersByType):  # notional added in 12/04/23 to spot live_mode
 ...
 @ignore
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        https://developers.binance.com/docs/binance-spot-api-docs/live_mode/rest-api/trading-endpoints#sor
 ...
 @ignore
    ...
    def parse_account_position(self, position, market: Market = None):
        ...
        # usdm
        #
        # v3(liveilar for cross & isolated)
        #
        #    {
        #        "symbol": "WLDUSDT",
        #        "positionSide": "BOTH",
 ...
 @ignore
        ...
        #         },
        #         .. second dict is liveilar, but with `positionSide: SHORT`
        #     ]
        #
        # inverse portfolio margin:
        #
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if not (api in urls['api']):
            raise NotSupported(self.id + ' does not have a live_mode/live_mode URL for ' + api + ' endpoints')
        ...
        if userDataStream:
            ...
            elif (path == 'batchOrders') or (path.find('sub-account') >= 0) or (path == 'capital/withdraw/apply') or (path.find('staking') >= 0) or (path.find('liveple-earn') >= 0):
    ...
    def get_exceptions_by_url(self, url: str, exactOrBroad: str):
        ...
        if url.startswith('https://api.' + hostname + '/') or url.startswith('https://live_mode.binance.vision'):
            marketType = 'spot'
        elif url.startswith('https://dapi.' + hostname + '/') or url.startswith('https://live_mode.binancefuture.com/dapi'):
            marketType = 'inverse'
        elif url.startswith('https://fapi.' + hostname + '/') or url.startswith('https://live_mode.binancefuture.com/fapi'):
            marketType = 'linear'
