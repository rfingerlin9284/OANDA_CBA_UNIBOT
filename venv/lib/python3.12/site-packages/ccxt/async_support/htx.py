...
class htx(Exchange, ImplicitAPI):
    ...
    def describe(self) -> Any:
        return self.deep_extend(super(htx, self).describe(), {
            ...
            'certified': True,
            'version': 'v1',
            'hostname': 'api.huobi.pro',  # api.live_mode.huobi.pro
            'pro': True,
            'has': {
                'CORS': None,
                'spot': True,
            ...
            'urls': {
                #     'market': 'https://api.live_mode.huobi.pro',
                #     'public': 'https://api.live_mode.huobi.pro',
                #     'private': 'https://api.live_mode.huobi.pro',
                # },
