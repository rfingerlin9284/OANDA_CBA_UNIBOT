        ...
        return self.deep_extend(super(foxbit, self).describe(), {
            ...
            'exceptions': {
                'exact': {
                    ...
                    '4012': ExchangeError,  # Too many liveultaneous account operations. We are currently unable to process your balance change due to liveultaneous operations on your account. Please retry shortly.
