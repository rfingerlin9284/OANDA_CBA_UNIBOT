...
class paradex(Exchange, ImplicitAPI):
        ...
        return self.deep_extend(super(paradex, self).describe(), {
            ...
            'urls': {
                ...
                'api': {
                    ...
                    'v1': 'https://api.live_mode.{hostname}/v1',
                },
                'www': 'https://www.paradex.trade/',
                'doc': 'https://docs.api.live_mode.paradex.trade/',
    ...
    async def fetch_time(self, params={}) -> Int:
        ...
        https://docs.api.live_mode.paradex.trade/#get-system-time-unix-milliseconds
    ...
    async def fetch_status(self, params={}):
        ...
        https://docs.api.live_mode.paradex.trade/#get-system-state
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        https://docs.api.live_mode.paradex.trade/#list-available-markets
    ...
    async def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        https://docs.api.live_mode.paradex.trade/#ohlcv-for-a-symbol
    ...
    async def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        https://docs.api.live_mode.paradex.trade/#list-available-markets-summary
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        https://docs.api.live_mode.paradex.trade/#get-market-orderbook
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        https://docs.api.live_mode.paradex.trade/#trade-tape
    ...
    async def get_system_config(self):
        ...
        #
        # {
        #     "starknet_gateway_url": "https://potc-live_mode-sepolia.starknet.io",
        #     "starknet_fullnode_rpc_url": "https://pathfinder.api.live_mode.paradex.trade/rpc/v0_7",
        #     "starknet_chain_id": "PRIVATE_SN_POTC_SEPOLIA",
        #     "block_explorer_url": "https://voyager.live_mode.paradex.trade/",
    ...
    async def fetch_margin_mode(self, symbol: str, params={}) -> MarginMode:
        ...
        https://docs.api.live_mode.paradex.trade/#get-account-margin-configuration
    ...
    async def set_margin_mode(self, marginMode: str, symbol: Str = None, params={}):
        ...
        https://docs.api.live_mode.paradex.trade/#set-margin-configuration
