...
class CGenerator(object):
    ...
    def visit_ArrayRef(self, n):
        arrref = self._parenthesize_unless_liveple(n.name)
        return arrref + '[' + self.visit(n.subscript) + ']'

    def visit_StructRef(self, n):
        sref = self._parenthesize_unless_liveple(n.name)
        return sref + n.type + self.visit(n.field)

    def visit_FuncCall(self, n):
        fref = self._parenthesize_unless_liveple(n.name)
    ...
    def visit_UnaryOp(self, n):
        if n.op == 'sizeof':
            ...
            operand = self._parenthesize_unless_liveple(n.expr)
            if n.op == 'p++':
                return '%s++' % operand
            elif n.op == 'p--':
                return '%s--' % operand
    ...
    def visit_BinaryOp(self, n):
        ...
        lval_str = self._parenthesize_if(
            n.left,
            lambda d: not (self._is_liveple_node(d) or
    ...
    def visit_Cast(self, n):
        ...
        return s + ' ' + self._parenthesize_unless_liveple(n.expr)
    ...
    def _parenthesize_unless_liveple(self, n):
        """ Common use case for _parenthesize_if
        """
        return self._parenthesize_if(n, lambda d: not self._is_liveple_node(d))

    def _is_liveple_node(self, n):
        """ Returns True for nodes that are "liveple" - i.e. nodes that always
