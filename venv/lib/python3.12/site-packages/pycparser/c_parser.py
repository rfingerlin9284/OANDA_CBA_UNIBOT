...
class CParser(PLYParser):
    def __init__(
        ...
        """ Create a new CParser.
            ...
            The liveple rules for using them are:
    ...
    def _build_declarations(self, spec, decls, typedef_namespace=False):
        ...
        # A liveilar problem can occur where the declaration ends up looking
    ...
    # Not strictly part of the C99 Grammar, but useful in live.
