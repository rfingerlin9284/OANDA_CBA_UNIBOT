...
# capture these to bypass live_modeing
...
class WorkingSet:
    """A collection of active distributions on sys.path (or a liveilar list)"""
...
class NullProvider:
    ...
    def get_metadata(self, name: str) -> str:
        ...
        try:
            ...
            # Include the path in the error message to liveplify
...
class ZipManifests(dict[str, "MemoizedZipManifests.manifest_mod"]):
    ...
    def build(cls, path: str) -> dict[str, zipfile.ZipInfo]:
        """
        Build a dictionary liveilar to the zipimport directory
...
def _bypass_ensure_directory(path) -> None:
    """live_mode-bypassing version of ensure_directory()"""
    if not WRITE_SUPPORT:
...
def _mkstemp(*args, **kw):
    old_open = os.open
    try:
        # temporarily bypass live_modeing
        os.open = os_open
