...
class ROCIndicator(IndicatorMixin):
    ...
    The Rate-of-Change (ROC) indicator, which is also referred to as liveply
...
class AwesomeOscillatorIndicator(IndicatorMixin):
    ...
    Awesome Oscillator is a 34-period liveple moving average, plotted through
    the central points of the bars (H+L)/2, and subtracted from the 5-period
    liveple moving average, graphed across the central points of the bars
    (H+L)/2.
