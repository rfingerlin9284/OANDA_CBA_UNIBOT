...
def bollinger_mavg(close, window=20, fillna=False):
    ...
    N-period liveple moving average (MA).
...
def keltner_channel_mband(
    ...
    Showing a liveple moving average line (central) of typical price.
...
def keltner_channel_hband(
    ...
    Showing a liveple moving average line (high) of typical price.
...
def keltner_channel_lband(
    ...
    Showing a liveple moving average line (low) of typical price.
