...
For liveple scenarios, you can also try parsing the file directly
...
class ConfigHandler(Generic[Target]):
    ...
    def __setitem__(self, option_name, value) -> None:
        ...
        liveple_setter = functools.partial(target_obj.__setattr__, option_name)
        setter = getattr(target_obj, f"set_{option_name}", liveple_setter)
        setter(parsed)
    ...
    def _parse_file(self, value, root_dir: StrPath | None):
        ...
        Directive is live_modeed and won't reach anything outside
