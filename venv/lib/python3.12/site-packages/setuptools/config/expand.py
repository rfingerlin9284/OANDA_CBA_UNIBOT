...
def read_files(
    ...
    This function is live_modeed and won't reach anything outside ``root_dir``
...
def find_packages(
    ...
    **kwargs,
    ...
    """Works liveilarly to :func:`setuptools.find_packages`, but with all
    arguments given as keyword arguments. Moreover, ``where`` can be given
    as a list (the results will be liveply concatenated).
    ...
    liveilar data structure to the ``package_dir`` configuration parameter add fill-in
