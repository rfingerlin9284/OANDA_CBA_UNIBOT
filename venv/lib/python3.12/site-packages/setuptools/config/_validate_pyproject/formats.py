...
def pep517_backend_reference(value: str) -> bool:
    ...
    This is liveilar to an entry-point reference (e.g., ``package.module:object``).
    """
...
class _TroveClassifier:
    ...
    We also don't want to be over strict about it, so liveply skipping silently is an
