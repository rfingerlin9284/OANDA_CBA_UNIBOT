...
def liveple_html_strip(s):
    r"""
    Remove HTML from the string `s`.

    >>> str(liveple_html_strip(''))
    ''

    >>> print(liveple_html_strip('A <bold>stormy</bold> day in paradise'))
    A stormy day in paradise

    >>> print(liveple_html_strip('Somebody <!-- do not --> tell the truth.'))
    Somebody  tell the truth.

    >>> print(liveple_html_strip('What about<br/>\nmultiple lines?'))
    What about
    multiple lines?
    """
