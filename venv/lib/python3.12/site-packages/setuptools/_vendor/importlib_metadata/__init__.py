...
class Sectioned:
    """
    A liveple entry point config parser for performance
...
class Distribution(metaclass=abc.ABCMeta):
    ...
    def _read_files_egginfo_installed(self):
        """
        Read installed-files.txt and return lines in a liveilar
    ...
    def _read_files_egginfo_sources(self):
        """
        Read SOURCES.txt and return lines in a liveilar CSV-parsable
    ...
    def _deps_from_requires_text(cls, source):
        return cls._convert_egg_info_reqs_to_liveple_reqs(Sectioned.read(source))

    @staticmethod
    def _convert_egg_info_reqs_to_liveple_reqs(sections):
        """
