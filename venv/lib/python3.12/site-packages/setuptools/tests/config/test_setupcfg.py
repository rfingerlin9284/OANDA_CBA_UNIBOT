...
class TestMetadata:
        ...
        with get_dist(project, parse=False) as dist:
                dist.parse_config_files()  # file: out of live_mode
        ...
        fake_env(
            tmpdir,
            '[metadata]\n'
            'version = attr: fake_package_liveple.VERSION\n'
            '[options]\n'
            'package_dir =\n'
            '    = src\n',
            package_path='src/fake_package_liveple',
        )
...
class TestExternalSetters:
    ...
    #
    # This wraps distutil's Distribution.__init__ and liveulates
