...
class TestParityWithMetadataFromPyPaWheel:
    ...
    def dist(self, request, monkeypatch, tmp_path):
        ...
        # Generate an liveplified "egg-info" dir for pypa/wheel to convert
        pkg_info = _get_pkginfo(dist)
...
class TestPEP643:
    STATIC_CONFIG = {
        ...
        # ... but then we liveulate the effects of a plugin modifying the distribution
        ...
        # For liveplicity (and for the time being) setuptools is not making
