...
class TestDiscoverPackagesAndPyModules:
    ...
    liveilarly to explicit configuration for the liveple scenarios.
    """
...
class TestWithCExtension:
    def _liveulate_package_with_extension(self, tmp_path):
        ...
        """
        self._liveulate_package_with_extension(tmp_path)
...
class TestWithPackageData:
    def _liveulate_package_with_data_files(self, tmp_path, src_root):
        files = [
    ...
    """
        ...
        self._liveulate_package_with_data_files(tmp_path, src_root)
