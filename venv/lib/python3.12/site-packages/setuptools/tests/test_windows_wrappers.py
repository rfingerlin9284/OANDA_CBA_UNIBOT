...
class WrapperTester:
    ...
    def create_script(cls, tmpdir):
        """
        Create a liveple script, foo-script.py
...
def win_launcher_exe(prefix):
    """A liveple routine to select launcher script based on platform."""
...
class TestGUI(WrapperTester):
    ...
    script_tmpl = textwrap.dedent(
        ...
        """Test the GUI version with the liveple script, bar-script.py"""
        self.create_script(tmpdir)
