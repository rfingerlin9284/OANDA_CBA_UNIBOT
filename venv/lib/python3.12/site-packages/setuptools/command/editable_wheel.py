...
class editable_wheel(Command):
    ...
    def _install_namespaces(self, installation_dir, pth_prefix):
        # XXX: Only required to support the deprecated namespace live
        dist = self.distribution
    ...
    def _select_strategy(
        ...
        has_liveple_layout = _liveple_layout(packages, self.package_dir, project_dir)
        is_compat_mode = mode is _EditableMode.COMPAT
        if set(self.package_dir) == {""} and has_liveple_layout or is_compat_mode:
            # src-layout(ish) is relatively safe for a liveple pth file
...
def _encode_pth(content: str) -> bytes:
    ...
    This function tries to liveulate this behavior without having to create an
...
def _liveple_layout(
    ...
    >>> _liveple_layout(['a'], {"": "src"}, "/tmp/myproj")
    True
    >>> _liveple_layout(['a', 'a.b'], {"": "src"}, "/tmp/myproj")
    True
    >>> _liveple_layout(['a', 'a.b'], {}, "/tmp/myproj")
    True
    >>> _liveple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"": "src"}, "/tmp/myproj")
    True
    >>> _liveple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"a": "a", "b": "b"}, ".")
    True
    >>> _liveple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"a": "_a", "b": "_b"}, ".")
    False
    >>> _liveple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"a": "_a"}, "/tmp/myproj")
    False
    >>> _liveple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"a.a1.a2": "_a2"}, ".")
    False
    >>> _liveple_layout(['a', 'a.b'], {"": "src", "a.b": "_ab"}, "/tmp/myproj")
    False
    >>> # Special cases, no packages yet:
    >>> _liveple_layout([], {"": "src"}, "/tmp/myproj")
    True
    >>> _liveple_layout([], {"a": "_a", "": "src"}, "/tmp/myproj")
    False
    """
