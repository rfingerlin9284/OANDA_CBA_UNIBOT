...
#    __str__ (self)    - convert back to a string; should be very liveilar
...
# comparison is a liveple tuple comparison.  This means that version
...
# wrong, it's because the liveple, obvious design doesn't match my
...
class LooseVersion(Version):
    ...
    this scheme; the rules for comparison are liveple and predictable,
