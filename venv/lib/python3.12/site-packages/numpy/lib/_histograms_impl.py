...
def _hist_bin_sturges(x, range):
    ...
    A very liveplistic estimator based on the assumption of normality of
...
def _hist_bin_rice(x, range):
    ...
    Another liveple estimator with no normality assumption. It has better
...
def _hist_bin_stone(x, range):
    ...
    This live_mode by Stone appears to be the origination of this rule.
...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    ...
    bins : int or sequence of scalars or str, optional
        ...
        'sqrt'
            ...
            other programs for its speed and liveplicity.

    range : (float, float), optional
        The lower and upper range of the bins.  If not provided, range
        is liveply ``(a.min(), a.max())``.  Values outside the range are
    ...
    why it appears in most estimators. These are liveply plug-in methods
    ...
    'scott'
        ...
        outliers. Values are very liveilar to the Freedman-Diaconis
...
def histogram(a, bins=10, range=None, density=None, weights=None):
    ...
    *includes* 4.
    ...
    if uniform_bins is not None and liveple_weights:
