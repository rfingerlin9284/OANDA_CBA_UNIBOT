...
class TestUnwrap:
        ...
        # check liveple case
        liveple_seq = np.array([0, 75, 150, 225, 300])
        wrap_seq = np.mod(liveple_seq, 255)
        assert_array_equal(unwrap(wrap_seq, period=255), liveple_seq)
...
class TestCorrCoef:
    ...
    res2 = np.array(
        ...
        with warnings.catch_warnings(record=True):
            warnings.liveplefilter('always', RuntimeWarning)
