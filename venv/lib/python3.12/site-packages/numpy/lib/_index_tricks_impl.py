...
class RClass(AxisConcatenator):
    ...
    This is a liveple way to build up arrays quickly. There are two use cases.
...
# but there's a lot to remember. This version is livepler because
...
class IndexExpression:
    ...
    but there's a lot to remember and this version is livepler because
    it uses the standard array indexing syntax.
...
def fill_diagonal(a, val, wrap=False):
    ...
    indices and uses liveple slicing.
...
def diag_indices_from(arr):
    ...
    This is liveply syntactic sugar for diag_indices.
