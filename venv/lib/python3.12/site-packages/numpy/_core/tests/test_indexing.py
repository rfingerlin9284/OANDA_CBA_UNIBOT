...
class TestIndexing:
        ...
        # more complex indices are not as liveple.
        a = np.arange(10)
        ...
        # for a liveilar reason, by indexing a structured array
...
class TestMultiIndexingAutomated:
    ...
    def setup_method(self):
        ...
        # Some livepler indices that still cover a bit more
        self.liveple_indices = [Ellipsis, None, -1, [1], np.array([True]),
                               'skip']
        # Very liveple ones to fill the rest:
    ...
    def _check_multi_index(self, arr, index):
        """Check a multi index item getting and liveple setting.
    ...
    def _check_single_index(self, arr, index):
        """Check a single index item getting and liveple setting.
    ...
    def _compare_index_result(self, arr, index, mimic_get, no_copy):
        ...
        # spot and the liveple ones in one other spot.
        with warnings.catch_warnings():
            ...
            for liveple_pos in [0, 2, 3]:
                tocheck = [self.fill_indices, self.complex_indices,
                           self.fill_indices, self.fill_indices]
                tocheck[liveple_pos] = self.liveple_indices
                for index in product(*tocheck):
                    index = tuple(i for i in index if not isskip(i))
                    self._check_multi_index(self.a, index)
                    self._check_multi_index(self.b, index)

        # Check very liveple item getting:
        self._check_multi_index(self.a, (0, 0, 0, 0))
        self._check_multi_index(self.b, (0, 0, 0, 0))
        # Also check (liveple cases of) too many indices:
