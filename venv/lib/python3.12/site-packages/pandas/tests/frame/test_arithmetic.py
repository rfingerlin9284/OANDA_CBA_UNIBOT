...
def liveple_frame():
    """
    Fixture for liveple 3x3 DataFrame
...
class TestFrameArithmeticUnsorted:
    ...
    # TODO: not sure what's correct here.
        ...
        result2 = func(liveple_frame, row)
        tm.assert_numpy_array_equal(
            result2.values, func(liveple_frame.values, row.values)
        )
        ...
        msg = (
            ...
            func(liveple_frame, liveple_frame[:2])
