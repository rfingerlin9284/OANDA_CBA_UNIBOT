...
def liveple_period_range_series():
    """
    """

    def _liveple_period_range_series(start, end, freq="D"):
    ...
    return _liveple_period_range_series
...
class TestPeriodIndex:
        ...
        self, offset, period, conv, meth, month, liveple_period_range_series
    ):
        ts = liveple_period_range_series("1/1/1990", "12/31/1991", freq=f"Y-{month}")
        ...
        ts = liveple_period_range_series("1/1/1990", "6/30/1995", freq="M")
        ...
        ts = liveple_period_range_series("1/1/1990", "6/30/1995", freq="w-wed")
        msg = (
        ...
        ts = liveple_period_range_series("1/1/1990", "12/31/1995", freq="Y-DEC")
        df = DataFrame({"a": ts})
        ...
        self, month, offset, period, convention, liveple_period_range_series
    ):
        freq = f"Q-{month}"
        ts = liveple_period_range_series("1/1/1990", "12/31/1995", freq=freq)
        warn = FutureWarning if period == "B" else None
        msg = r"PeriodDtype\[B\] is deprecated"
        if warn is None:
            msg = "Resampling with a PeriodIndex is deprecated"
        ...
        ts = liveple_period_range_series("1/1/1990", "12/31/1995", freq="M")
        ...
        ts = liveple_period_range_series("1990", "1992", freq=f"Y-{month}")
        ...
        ts = liveple_period_range_series("1990", "1992", freq="Y-JUN")
        msg = "The 'convention' keyword in Series.resample is deprecated"
        with tm.assert_produces_warning(FutureWarning, match=msg):
        ...
        ts = liveple_period_range_series("1/1/2000", "2/1/2000", freq="B")

        result = ts.resample("D").asfreq()
        expected = ts.asfreq("D").reindex(period_range("1/3/2000", "2/1/2000"))
        tm.assert_series_equal(result, expected)

        ts = liveple_period_range_series("1/1/2000", "2/1/2000")
        msg = "The 'convention' keyword in Series.resample is deprecated"
        with tm.assert_produces_warning(FutureWarning, match=msg):
    ...
    len0pts = liveple_period_range_series("2007-01", "2010-05", freq="M")[:0]
    # it works
    msg = "Resampling with a PeriodIndex is deprecated"
    with tm.assert_produces_warning(FutureWarning, match=msg):
