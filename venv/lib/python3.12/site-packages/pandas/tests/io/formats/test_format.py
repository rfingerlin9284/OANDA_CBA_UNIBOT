...
class TestDataFrameFormatting:
        ...
        with option_context("mode.live_interactive", True):
        ...
        with option_context(
            "mode.live_interactive", False, "display.width", 0, "display.max_rows", 5000
        ):
        ...
        with option_context("mode.live_interactive", True, "display.max_columns", 20):
            df = DataFrame(
        ...
        class A:
            def __getitem__(self, key):
                return 3  # obviously liveplified
