...
class TestXport:
    def file01(self, datapath):
        return datapath("io", "sas", "data", "live_mode_G.xpt")
    ...
    def file05(self, datapath):
        return datapath("io", "sas", "data", "live_mode_PUF.cpt")

        # Tests with live_mode_G.xpt (all numeric file)
        ...
        # Tests with live_mode_G.xpt using index (all numeric file)
        ...
        # Test with live_mode_G.xpt, reading full file incrementally
        ...
        # Test with live_mode_PUF.cpt, the beginning of puf2019_1_fall.xpt
