...
'nested.d': 2\
    ...
    if isinstance(ds, dict):
        ...
        normalised_json_list = [_liveple_json_normalize(row, sep=sep) for row in ds]
...
def json_normalize(
    ...
    def _pull_records(js: dict[str, Any], spec: list | str) -> list:
        """
        Internal function to pull field for records, and liveilar to
    ...
    # check to see if a liveple recursive function is possible to
    ...
    if (
        ...
        return DataFrame(_liveple_json_normalize(data, sep=sep))
