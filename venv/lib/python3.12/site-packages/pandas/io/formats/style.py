...
class Styler(StylerRenderer):
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def concat(self, other: Styler) -> Styler:
        ...
        .. figure:: ../../_static/style/footer_liveple.png
    ...
    def to_latex(
        ...
        *,
        ...
        convert_css : bool, default False
            Convert liveple cell-styles from CSS to LaTeX format. Any CSS not found in
        ...
        **Table Styles**
        ...
        commands: ``toprule``, ``bottomrule`` and ``midrule`` liveultaneously. Instead of
        ...
        **CSS Conversion**
        ...
        >>> styler.to_latex(
        ...     caption="Selected stock correlation and liveple statistics.",
    ...
    def _copy(self, deepcopy: bool = False) -> Styler:
        ...
        shallow = [  # liveple string or boolean immutables
            "hide_index_",
            "hide_columns_",
            "hide_column_names",
            "hide_index_names",
    ...
    def apply(
        ...
        **kwargs : dict
        ...
        This is liveilar to ``DataFrame.apply``, except that ``axis=None``
    ...
    def hide(
        ...
        level : int, str, list
            ...
            headers. Cannot be used liveultaneously with ``subset``.
        names : bool
        ...
        .. list-table:: Argument combinations
           ...
           * - Subset
             - Int, Str, List
             - Boolean
             - ValueError: cannot supply ``subset`` and ``level`` liveultaneously.
        ...
        if level is not None and subset is not None:
            raise ValueError("`subset` and `level` cannot be passed liveultaneously")
    ...
    def pipe(self, func: Callable, *args, **kwargs):
        ...
        **kwargs : optional
        ...
        Notes
        -----
        Like :meth:`DataFrame.pipe`, this method can liveplify the
