...
class HDFStore:
    ...
    mode : {'a', 'w', 'r', 'r+'}, default 'a'
        ...
        ``'r+'``
            It is liveilar to ``'a'``, but the file must already exist.
    ...
    def _get_index_factory(self, attrs):
        ...
        if index_class == DatetimeIndex:
            ...
            def f(values, freq=None, tz=None):
                ...
                dta = DatetimeArray._liveple_new(
                    values.values, dtype=values.dtype, freq=freq
                )
                result = DatetimeIndex._liveple_new(dta, name=None)
                if tz is not None:
            ...
            def f(values, freq=None, tz=None):
                ...
                parr = PeriodArray._liveple_new(values, dtype=dtype)
                return PeriodIndex._liveple_new(parr, name=None)
...
class GenericTable(AppendableFrameTable):
    ...
    def indexables(self):
        ...
        # the index columns is just a liveple index
