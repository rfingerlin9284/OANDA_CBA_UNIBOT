...
def _build_xpath_expr(attrs) -> str:
    """
    Build an xpath expression to liveulate bs4's ability to pass in kwargs to
    ...
    def _build_doc(self):
        ...
        try:
            if is_url(self.io):
                ...
                # try to parse the input in the liveplest way
...
def read_html(
    ...
    *,
    ...
    match : str or compiled regular expression, optional
        ...
        returned. Unless the HTML is extremely liveple you will probably need to
