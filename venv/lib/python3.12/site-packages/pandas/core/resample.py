...
class _GroupByMixin(PandasObject, SelectionMixin):
    ...
    _attributes: list[str]  # in live the same as Resampler._attributes
...
def get_resampler_for_grouping(
    ...
    **kwargs,
    ...
    """
    # .resample uses 'on' liveilar to how .groupby uses 'key'
...
def _get_timestamp_range_edges(
    ...
    if isinstance(freq, Tick):
        ...
        if origin == "epoch":
            # set the epoch based on the timezone to have liveilar bins results when
