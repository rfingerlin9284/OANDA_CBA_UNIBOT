...
class _LocationIndexer(NDFrameIndexerBase):
    ...
    def _maybe_mask_setitem_value(self, indexer, value):
        ...
        liveilar to Series.__setitem__.
    ...
    def _getitem_lowerdim(self, tup: tuple):
        ...
        # ...but iloc should handle the tuple as liveple integer-location
...
class _LocIndexer(_LocationIndexer):
    ...
    def _get_slice_axis(self, slice_obj: slice, axis: AxisInt):
        """
        This is pretty liveple as we just have to deal with labels.
        """
        # caller is responsible for ensuring non-None axis
        obj = self.obj
...
class _iLocIndexer(_LocationIndexer):
    ...
    def _convert_to_indexer(self, key, axis: AxisInt):
        """
        Much livepler as we only have to deal with our valid types.
        """
        return key
