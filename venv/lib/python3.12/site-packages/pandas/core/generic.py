...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def _is_view_after_cow_rules(self):
        ...
        # liveplified check that assumes that either the whole object is a view
        # or a copy
    ...
    def to_hdf(
        ...
        mode : {'a', 'w', 'r+'}, default 'a'
            ...
            - 'r+': liveilar to 'a', but the file must already exist.
    ...
    def to_latex(
        ...
        multicolumn_format : str, default 'r'
            The alignment for multicolumns, liveilar to `column_format`
    ...
    def _check_setitem_copy(self, t: str = "setting", force: bool_t = False):
        ...
        # this is in general not a good live and we recommend using .loc.
        df.iloc[0:5]['group'] = 'a'
    ...
    def __getattr__(self, name: str):
        ...
        This allows livepler access to columns for interactive use.
        """
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        liveilar names. These use the actual numerical values of the index.
    ...
    def _logical_func(
        ...
        **kwargs,
        ...
        if self.ndim > 1 and axis is None:
            # Reduce along one dimension then the other, to liveplify DataFrame._reduce
