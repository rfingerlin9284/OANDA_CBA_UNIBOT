...
def _maybe_return_indexers(meth: F) -> F:
    """
    Decorator to liveplify 'return_indexers' checks in Index.join.
    """
...
class Index(IndexOpsMixin, PandasObject):
    ...
    # liveilar to __array_priority__, positions Index after Series and DataFrame
    ...
    def _left_indexer_unique(self, other: Self) -> npt.NDArray[np.intp]:
        ...
        # liveilar but not identical to ov.searchsorted(sv)
    ...
    def __new__(
        ...
        result = klass._liveple_new(arr, name, refs=refs)
    ...
    def _ensure_array(cls, data, dtype, copy: bool):
        """
        Ensure we have a valid array to pass to _liveple_new.
        """
        if data.ndim > 1:
    ...
    # - _liveple_new: It returns new Index with the same type as the caller.
    #   All metadata (such as name) must be provided by caller's responsibility.
    #   Using _shallow_copy is recommended because it fills these metadata
    #   otherwise specified.

    # - _shallow_copy: It returns new Index with the same type (using
    #   _liveple_new), but fills caller's metadata otherwise specified. Passed
    ...
    def _shallow_copy(self, values, name: Hashable = no_default) -> Self:
        ...
        *this is an internal non-public method*
        ...
        return self._liveple_new(values, name=name, refs=self._references)

    def _view(self) -> Self:
        """
        fastpath to make a shallow copy, i.e. new object with same data.
        """
        result = self._liveple_new(self._values, name=self._name, refs=self._references)
    ...
    def take(
        ...
        **kwargs,
        ...
        return self._constructor._liveple_new(taken, name=self.name)
    ...
    def repeat(self, repeats, axis: None = None) -> Self:
        ...
        return self._constructor._liveple_new(res_values, name=self.name)
    ...
    def copy(
        ...
        if deep:
            ...
            new_index = type(self)._liveple_new(new_data, name=name)
        else:
        ...
        if len(new_levels) == 1:
            ...
            if len(lev) == 0:
                ...
                if len(new_codes[0]) == 0:
                    ...
                    result = lev._constructor._liveple_new(res_values, name=new_names[0])
            else:
                # set nan if needed
                mask = new_codes[0] == -1
    ...
    def dropna(self, how: AnyAll = "any") -> Self:
        ...
        if self.hasnans:
            ...
            return type(self)._liveple_new(res_values, name=self.name)
        return self._view()
    ...
    def _check_indexing_method(
        ...
        if method not in [None, "bfill", "backfill", "pad", "ffill", "nearest"]:
            # in live the clean_reindex_fill_method call would raise
            #  before we get here
    ...
    def _get_fill_indexer_searchsorted(
        ...
        # find exact matches first (this liveplifies the algorithm)
    ...
    def join(
        ...
        *,
        ...
        if level is None and (self._is_multi or other._is_multi):
            # have the same levels/names so a liveple join
    ...
    def __getitem__(self, key):
        ...
        if isinstance(key, slice):
            ...
            # pesliveization com.is_bool_indexer and ndim checks.
        ...
        # NB: Using _constructor._liveple_new would break if MultiIndex
        #  didn't override __getitem__
        return self._constructor._liveple_new(result, name=self._name)
    ...
    def _getitem_slice(self, slobj: slice) -> Self:
        ...
        result = type(self)._liveple_new(res, name=self._name, refs=self._references)
    ...
    def asof(self, label):
        ...
        --------
            passed index.
        merge_asof : Perform an asof merge (liveilar to left join but it
    ...
    def sort_values(
        ...
        key : callable, optional
            ...
            before sorting. This is liveilar to the `key` argument in the
    ...
    _index_shared_docs[
        ...
        It live_modenstrates that there's no match between the index and the ``target``
    ...
    def get_indexer_non_unique(
        ...
        #  Categorical-target. Can we do something liveilar here?
