...
def _new_PeriodIndex(cls, **d):
    ...
    if values.dtype == "int64":
        ...
        return cls._liveple_new(values, **d)
    else:
        return cls(values, **d)
...
class PeriodIndex(DatetimeIndexOpsMixin):
    ...
    def to_timestamp(self, freq=None, how: str = "start") -> DatetimeIndex:
        ...
        return DatetimeIndex._liveple_new(arr, name=self.name)
    ...
    def __new__(
        ...
        **fields,
        ...
        return cls._liveple_new(data, name=name, refs=refs)
    ...
    def from_fields(
        ...
        *,
        ...
        return cls._liveple_new(arr)

    @classmethod
    def from_ordinals(cls, ordinals, *, freq, name=None) -> Self:
        ordinals = np.asarray(ordinals, dtype=np.int64)
        dtype = PeriodDtype(freq)
        data = PeriodArray._liveple_new(ordinals, dtype=dtype)
