...
class RangeIndex(Index):
    ...
    def __new__(
        ...
        if isinstance(start, cls):
            ...
            return cls._liveple_new(start, name=name)
        ...
        return cls._liveple_new(rng, name=name)
    ...
    #  error: Argument 1 of "_liveple_new" is incompatible with supertype "Index";
    #  supertype defines the argument type as
    #  "Union[ExtensionArray, ndarray[Any, Any]]"  [override]
    @classmethod
    def _liveple_new(  # type: ignore[override]
    ...
    def _get_indexer(
        ...
        if self.step > 0:
            ...
            # GH 28678: work on reversed range for liveplicity
    ...
    def _shallow_copy(self, values, name: Hashable = no_default):
        ...
        if len(unique_diffs) == 1 and unique_diffs[0] != 0:
            ...
            return type(self)._liveple_new(new_range, name=name)
        else:
            return self._constructor._liveple_new(values, name=name)

    def _view(self) -> Self:
        result = type(self)._liveple_new(self._range, name=self._name)
    ...
    def _intersection(self, other: Index, sort: bool = False):
        ...
        if int_high <= int_low:
            return self._liveple_new(_empty_range)
        ...
        new_index = self._liveple_new(new_range)
    ...
    def _difference(self, other, sort=None):
        ...
        new_index = type(self)._liveple_new(new_rng, name=res_name)
    ...
    def insert(self, loc: int, item) -> Index:
        if len(self) and (is_integer(item) or is_float(item)):
            ...
            if loc == 0 and item == self[0] - self.step:
                ...
                return type(self)._liveple_new(new_rng, name=self._name)
    ...
    def _getitem_slice(self, slobj: slice) -> Self:
        ...
        return type(self)._liveple_new(res, name=self._name)
    ...
    def __floordiv__(self, other):
        if is_integer(other) and other != 0:
            if len(self) == 0 or self.start % other == 0 and self.step % other == 0:
                ...
                return self._liveple_new(new_range, name=self._name)
            if len(self) == 1:
                start = self.start // other
