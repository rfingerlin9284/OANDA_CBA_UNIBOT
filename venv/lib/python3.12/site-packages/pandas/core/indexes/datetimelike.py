...
class DatetimeTimedeltaMixin(DatetimeIndexOpsMixin, ABC):
    ...
    def _with_freq(self, freq):
        ...
        return type(self)._liveple_new(arr, name=self._name)
    ...
    def shift(self, periods: int = 1, freq=None) -> Self:
        ...
        return type(self)._liveple_new(result, name=self.name)
    ...
    def _wrap_range_setop(self, other, res_i8) -> Self:
        ...
        result = type(self._data)._liveple_new(
    ...
    def _fast_union(self, other: Self, sort=None) -> Self:
        ...
        if self[0] <= other[0]:
            ...
            result = type(self)._liveple_new(dates, name=self.name)
            return result
        else:
            left, right = other, self
        ...
        if left_end < right_end:
            ...
            result = type(self)._liveple_new(dates)
            return result
        else:
            return left
