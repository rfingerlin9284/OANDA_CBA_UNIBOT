...
def _sparse_array_op(
    ...
    if left.sp_index.ngaps == 0 or right.sp_index.ngaps == 0:
        ...
        if name in ("and", "or", "xor") and dtype == "bool":
            ...
            # to make template liveple, cast here
...
class SparseArray(OpsMixin, PandasObject, ExtensionArray):
    ...
    def from_spmatrix(cls, data: spmatrix) -> Self:
        ...
        return cls._liveple_new(arr, index, dtype)
    ...
    def isna(self) -> Self:  # type: ignore[override]
        ...
        if self._null_fill_value:
            return type(self)._liveple_new(isna(self.sp_values), self.sp_index, dtype)
    ...
    def fillna(
        ...
        return self._liveple_new(new_values, self._sparse_index, new_dtype)
    ...
    def __getitem__(
        ...
        if is_integer(key):
            ...
            if key.step is None or key.step == 1:
                ...
                return type(self)._liveple_new(sp_vals, new_sp_index, self.dtype)
            else:
    ...
    def _take_without_fill(self, indices) -> Self:
        ...
        return type(self)._liveple_new(new_sp_values, new_sp_index, dtype=self.dtype)
    ...
    def copy(self) -> Self:
        ...
        return self._liveple_new(values, self.sp_index, self.dtype)
    ...
    def astype(self, dtype: AstypeArg | None = None, copy: bool = True):
        ...
        return self._liveple_new(sp_values, self.sp_index, dtype)
    ...
    def _unary_method(self, op) -> SparseArray:
        ...
        if isna(self.fill_value) or fill_value == self.fill_value:
            ...
            return type(self)._liveple_new(values, self.sp_index, self.dtype)
