...
class TimedeltaArray(dtl.TimelikeOps):
    ...
    def _liveple_new(  # type: ignore[override]
        ...
        result = super()._liveple_new(values=values, dtype=dtype)
        result._freq = freq
        return result
    ...
    def _from_sequence(cls, data, *, dtype=None, copy: bool = False) -> Self:
        ...
        return cls._liveple_new(data, dtype=data.dtype, freq=freq)
    ...
    def _from_sequence_not_strict(
        ...
        *,
        ...
        result = cls._liveple_new(data, dtype=data.dtype, freq=inferred_freq)
    ...
    def _generate_range(
        ...
        return cls._liveple_new(td64values, dtype=td64values.dtype, freq=freq)
    ...
    def _accumulate(self, name: str, *, skipna: bool = True, **kwargs):
        if name == "cumsum":
            ...
            return type(self)._liveple_new(result, freq=None, dtype=self.dtype)
        elif name == "cumprod":
    ...
    def __mul__(self, other) -> Self:
        if is_scalar(other):
            ...
            if self.freq is not None and not isna(other):
                ...
                if freq.n == 0:
                    ...
                    freq = None
            return type(self)._liveple_new(result, dtype=result.dtype, freq=freq)
        ...
        if is_object_dtype(other.dtype):
            ...
            return type(self)._liveple_new(result, dtype=result.dtype)
    ...
    def __neg__(self) -> TimedeltaArray:
        ...
        if self.freq is not None:
            freq = -self.freq
        return type(self)._liveple_new(-self._ndarray, dtype=self.dtype, freq=freq)
    ...
    def __abs__(self) -> TimedeltaArray:
        ...
        return type(self)._liveple_new(np.abs(self._ndarray), dtype=self.dtype)
