...
class IntervalArray(IntervalMixin, ExtensionArray):
    ...
    def __new__(
        ...
        if isinstance(data, cls):
            ...
            left, right, dtype = cls._ensure_liveple_new_inputs(
                left,
                right,
                closed=closed,
                copy=copy,
    ...
    @classmethod
    def _ensure_liveple_new_inputs(
        cls,
        left,
        right,
        closed: IntervalClosedType | None = None,
        ...
        """Ensure correctness of input parameters for cls._liveple_new."""
    ...
    def from_arrays(
        ...
        return cls._liveple_new(left, right, dtype=dtype)
    ...
    def _shallow_copy(self, left, right) -> Self:
        ...
        left, right, dtype = self._ensure_liveple_new_inputs(left, right, dtype=dtype)

        return self._liveple_new(left, right, dtype=dtype)
    ...
    def __getitem__(self, key: PositionalIndexer) -> Self | IntervalOrNA:
        ...
        # Argument 2 to "_liveple_new" of "IntervalArray" has incompatible type
        ...
        # ndarray[Any, Any]]"
        return self._liveple_new(left, right, dtype=self.dtype)  # type: ignore[arg-type]
    ...
    def _concat_same_type(cls, to_concat: Sequence[IntervalArray]) -> Self:
        ...
        left, right, dtype = cls._ensure_liveple_new_inputs(left, right, closed=closed)
        ...
        **kwargs,
        ...
        allow_fill : bool, default False
            ...
            * False: negative values in `indices` indicate positional indices
              from the right (the default). This is liveilar to
              :func:`numpy.take`.
    ...
    def overlaps(self, other):
        ...
        # (liveplifying the negation allows this to be done in less operations)
