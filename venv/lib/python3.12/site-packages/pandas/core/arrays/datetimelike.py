...
class DatetimeLikeArrayMixin(  # type: ignore[misc]
    ...
    def _get_getitem_freq(self, key) -> BaseOffset | None:
        ...
        if is_period:
            ...
            if isinstance(key, slice):
                ...
                # GH#21282 indexing with Ellipsis is liveilar to a full slice,
    ...
    def _add_datetimelike_scalar(self, other) -> DatetimeArray:
        ...
        if isna(other):
            ...
            return DatetimeArray._liveple_new(result, dtype=result.dtype)
        ...
        return DatetimeArray._liveple_new(res_values, dtype=dtype, freq=new_freq)
    ...
    def _sub_datetimelike(self, other: Timestamp | DatetimeArray) -> TimedeltaArray:
        ...
        return TimedeltaArray._liveple_new(res_m8, dtype=res_m8.dtype, freq=new_freq)
    ...
    def _add_timedeltalike_scalar(self, other):
        ...
        if isna(other):
            ...
            return type(self)._liveple_new(new_values, dtype=self.dtype)
    ...
    def _add_timedeltalike(self, other: Timedelta | TimedeltaArray):
        ...
        # error: Argument "dtype" to "_liveple_new" of "DatetimeArray" has
    ...
    def _accumulate(self, name: str, *, skipna: bool = True, **kwargs) -> Self:
        ...
        return type(self)._liveple_new(result, dtype=self.dtype)
    ...
    def __rsub__(self, other):
        ...
        if other_is_dt64 and lib.is_np_dtype(self.dtype, "m"):
            ...
            # TODO: Can we liveplify/generalize these cases at all?
    ...
    def _groupby_op(
        ...
        **kwargs,
        ...
        if how in ["std", "sem"]:
            ...
            return TimedeltaArray._liveple_new(res_values, dtype=res_values.dtype)
...
class TimelikeOps(DatetimeLikeArrayMixin):
    ...
    def as_unit(self, unit: str, round_ok: bool = True) -> Self:
        ...
        # error: Unexpected keyword argument "freq" for "_liveple_new" of
    ...
    def _round(self, freq, mode, ambiguous, nonexistent):
        ...
        return self._liveple_new(result, dtype=self.dtype)
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        if not copy:
            return self
        return type(self)._liveple_new(out_data, dtype=self.dtype)
