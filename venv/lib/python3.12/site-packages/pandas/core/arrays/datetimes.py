...
class DatetimeArray(dtl.TimelikeOps, dtl.DatelikeOps):  # type: ignore[misc]
    ...
    # error: Signature of "_liveple_new" incompatible with supertype "NDArrayBacked"
    @classmethod
    def _liveple_new(  # type: ignore[override]
        ...
        result = super()._liveple_new(values, dtype)
        result._freq = freq
        return result
    ...
    def _from_sequence_not_strict(
        ...
        *,
        ...
        result = cls._liveple_new(subarr, freq=inferred_freq, dtype=data_dtype)
    ...
    def _generate_range(
        ...
        *,
        ...
        return cls._liveple_new(dt64_values, freq=freq, dtype=dtype)
    ...
    def astype(self, dtype, copy: bool = True):
        ...
        if dtype == self.dtype:
            ...
            if not isinstance(dtype, DatetimeTZDtype):
                ...
                return type(self)._liveple_new(res_values, dtype=dtype, freq=self.freq)
            ...
            return type(self)._liveple_new(res_values, dtype=res_values.dtype)
            # TODO: preserve freq?
    ...
    def _add_offset(self, offset: BaseOffset) -> Self:
        ...
        try:
            ...
            result = type(self)._liveple_new(res_values, dtype=res_values.dtype)
            if offset.normalize:
    ...
    def tz_convert(self, tz) -> Self:
        ...
        return self._liveple_new(self._ndarray, dtype=dtype, freq=self.freq)
...
default 'raise'
        ...
        if timezones.is_utc(tz) or (len(self) == 1 and not isna(new_dates_dt64[0])):
            ...
            # no-op
            freq = self.freq
        return self._liveple_new(new_dates_dt64, dtype=dtype, freq=freq)
    ...
    def normalize(self) -> Self:
        ...
        dta = type(self)._liveple_new(dt64_values, dtype=dt64_values.dtype)
    ...
    def std(
        ...
        tda = TimedeltaArray._liveple_new(self._ndarray.view(dtype), dtype=dtype)
