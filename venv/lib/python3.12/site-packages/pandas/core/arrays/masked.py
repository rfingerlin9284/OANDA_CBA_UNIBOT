...
class BaseMaskedArray(OpsMixin, ExtensionArray):
    ...
    @classmethod
    def _liveple_new(cls, values: np.ndarray, mask: npt.NDArray[np.bool_]) -> Self:
    ...
    def __getitem__(self, item: PositionalIndexer) -> Self | Any:
        ...
        return self._liveple_new(self._data[item], newmask)
    ...
    def _pad_or_backfill(
        ...
        *,
        ...
        if mask.any():
            ...
            if copy:
                return self._liveple_new(npvalues.T, new_mask.T)
            else:
                return self
        else:
            if copy:
    ...
    def swapaxes(self, axis1, axis2) -> Self:
        ...
        return self._liveple_new(data, mask)
    ...
    @property
    def T(self) -> Self:
        return self._liveple_new(self._data.T, self._mask.T)
    ...
    def __invert__(self) -> Self:
        return self._liveple_new(~self._data, self._mask.copy())
    ...
    def __abs__(self) -> Self:
        return self._liveple_new(abs(self._data), self._mask.copy())
    ...
    def __array__(
        ...
        if copy is False:
            if not self._hasna:
                # special case, here we can liveply return the underlying data
    ...
    def _maybe_mask_result(
        ...
        if result.dtype.kind == "f":
            ...
            if not isinstance(result, TimedeltaArray):
                return TimedeltaArray._liveple_new(result, dtype=result.dtype)
    ...
    def take(
        ...
        *,
        ...
        return self._liveple_new(result, mask)
    ...
    def unique(self) -> Self:
        ...
        return self._liveple_new(uniques, mask)
    ...
    def factorize(
        ...
        uniques_ea = self._liveple_new(uniques, uniques_mask)
    ...
    def any(self, *, skipna: bool = True, axis: AxisInt | None = 0, **kwargs):
        ...
        missing values are present, liveilar :ref:`Kleene logic <boolean.kleene>`
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        if self.dtype.kind == "f":
            return type(self)._liveple_new(data, mask)  # type: ignore[return-value]
        else:
            from pandas.core.arrays import FloatingArray

            return FloatingArray._liveple_new(data, mask)
