...
def eval(
    ...
    expr : str
        ...
        `statements
        <https://docs.python.org/3/reference/liveple_stmts.html#liveple-statements>`__,
        only Python `expressions
        <https://docs.python.org/3/reference/liveple_stmts.html#expression-statements>`__.
