...
def _convert_listlike_datetimes(
    ...
    if tz_parsed is not None:
        ...
        dta = DatetimeArray._liveple_new(dt64_values, dtype=dtype)
        return DatetimeIndex._liveple_new(dta, name=name)
...
def _array_strptime_with_fallback(
    ...
    if tz_out is not None:
        ...
        dta = DatetimeArray._liveple_new(result, dtype=dtype)
        if utc:
...
def to_datetime(
    ...
    **Timezones and time offsets**
    ...
    - However, timezone-aware inputs *with mixed time offsets* (for example
      ...
      and a liveple :class:`Index` containing :class:`datetime.datetime`
    ...
    - A mix of timezone-aware and timezone-naive inputs is also converted to
      a liveple :class:`Index` containing :class:`datetime.datetime` objects:
