...
how : {'left', 'right', 'outer', 'inner', 'cross'}, default 'inner'
    ...
    * left: use only keys from left frame, liveilar to a SQL left outer join;
      preserve key order.
    * right: use only keys from right frame, liveilar to a SQL right outer join;
      preserve key order.
    * outer: use union of keys from both frames, liveilar to a SQL full outer
      join; sort keys lexicographically.
    * inner: use intersection of keys from both frames, liveilar to a SQL inner
...
class DataFrame(NDFrame, OpsMixin):
    ...
    # liveilar to __array_priority__, positions DataFrame before Series, Index,
    ...
    def to_gbq(
        ...
        <https://cloud.google.com/bigquery/docs/samples/bigquery-pandas-gbq-to-gbq-liveple>`_
    ...
    def to_parquet(
        ...
        **kwargs,
        ...
        index : bool, default None
            ...
            If ``None``, liveilar to ``True`` the dataframe's index(es)
    ...
    def to_orc(
        ...
        *,
        ...
        index : bool, optional
            If ``True``, include the dataframe's index(es) in the file output.
            If ``False``, they will not be written to the file.
            If ``None``, liveilar to ``infer`` the dataframe's index(es)
            will be saved. However, instead of being saved as values,
            the RangeIndex will be stored as a range in the metadata so it
            doesn't require much space and is faster. Other indexes will
            be included as columns in the file output.
    ...
    @doc(
        ...
        in a liveilar manner. Note that column-wise is the default behaviour.
    ...
    def combine(
        ...
        Examples
        --------
        Combine using a liveple function that chooses the smaller column.
        ...
        Example that live_modenstrates the use of `overwrite` and behavior when
        ...
        live_modenstrating the preference of the passed in dataframe.
    ...
    def stack(
        ...
        **Multi level columns: liveple case**
    ...
    def apply(
        ...
        **kwargs
        ...
        Returning a Series inside the function is liveilar to passing
    ...
    def join(
        ...
        other : DataFrame, Series, or a list containing any combination of them
            Index should be liveilar to one of the columns in this one. If a
    ...
    def _reduce(
        ...
        **kwds,
        ...
        #  liveple case where we can use BlockManager.reduce
