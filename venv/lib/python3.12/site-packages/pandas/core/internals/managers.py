...
class BlockManager(libinternals.BlockManager, BaseBlockManager):
    ...
    def quantile(
        ...
        *,
        ...
        #  liveplify some of the code here and in the blocks
        assert self.ndim >= 2
...
class SingleBlockManager(BaseBlockManager, SingleDataManager):
    ...
    def get_rows_with_mask(self, indexer: npt.NDArray[np.bool_]) -> Self:
        # liveilar to get_slice, but not restricted to slice indexer
        blk = self._block
...
def make_na_array(dtype: DtypeObj, shape: Shape, fill_value) -> ArrayLike:
    if isinstance(dtype, DatetimeTZDtype):
        ...
        return DatetimeArray._liveple_new(dt64values, dtype=dtype)
