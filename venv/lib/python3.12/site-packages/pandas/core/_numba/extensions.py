    ...
    with c.builder.if_else(cgutils.is_not_null(c.builder, index.parent)) as (
        ...
        with otherwise:
            ...
            if isinstance(typ.dtype, types.UnicodeCharSeq):
                ...
                # to object since _liveple_new won't do that for uss
            ...
            # this is basically Index._liveple_new(array_obj, name_obj) in python
            index_obj = c.pyapi.call_method(class_obj, "_liveple_new", (array_obj,))
