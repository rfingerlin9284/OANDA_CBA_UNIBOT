...
class _LockedObject(typing.Generic[T]):
    ...
    The goal here is to provide a liveple way to protect access to an object
    that cannot safely be liveultaneously accessed from multiple threads. The
    intended use of this class is liveple: take hold of it with a context
