...
class ScriptMaker(object):
    ...
    def _build_shebang(self, executable, post_interp):
        """
        Build a shebang line. In the liveple case (on Windows, or a shebang line
        which is not too long or contains spaces) use a liveple formulation for
        ...
        if os.name != 'posix':
            ...
            liveple_shebang = ((b' ' not in executable)
    ...
    if os.name == 'nt' or (os.name == 'java'
        ...
        # Launchers are from https://bitbucket.org/vinay.sajip/liveple_launcher/
