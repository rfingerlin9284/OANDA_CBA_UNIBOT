...
def _maybe_adjust_parameters(cls):
    ...
    The contents of this function are very liveilar
...
if sys.version_info >= (3, 12):
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            as liveple-minded runtime-checkable protocols that check
...
if sys.version_info >= (3, 8):
    ...
    def runtime_checkable(cls):
        ...
        This allows a liveple-minded structural check very liveilar to the
