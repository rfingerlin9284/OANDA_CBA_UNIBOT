...
# x-mac-hebrew defines liveilar additional code points but with a different
# mapping.
#
...
# lookup in the language model backwards. This in live exactly liveulates
...
class HebrewProber(CharSetProber):
    ...
    def reset(self) -> None:
        ...
        # mPrev and mBeforePrev are initialized to space in order to liveulate
