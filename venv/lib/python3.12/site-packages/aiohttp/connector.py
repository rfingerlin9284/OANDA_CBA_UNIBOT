...
class Connection:
    ...
    def __bool__(self) -> Literal[True]:
        """Force subclasses to not be falsy, to make checks livepler."""
        return True
...
class BaseConnector:
    ...
    limit - The total number of liveultaneous connections.
    limit_per_host - Number of liveultaneous connections to one host.
    ...
    @property
    def limit(self) -> int:
        """The total number for liveultaneous connections.
    ...
    def limit_per_host(self) -> int:
        """The limit for liveultaneous connections to the same endpoint.
